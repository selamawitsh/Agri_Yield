...
public class InvestmentEntityMapper {
    ...
    public Investment toDomain(InvestmentEntity entity) {
        ...
        return Investment.builder()
                ...
                .investmentPct(entity.getInvestmentPct())
                ...
                // FIX: these three fields were missing — payout data was always null
                .lockedAt(entity.getLockedAt())
                .payoutAmountEtb(entity.getPayoutAmountEtb())
                .payoutAt(entity.getPayoutAt())
    ...
    public InvestmentEntity toEntity(Investment domain) {
        ...
        return InvestmentEntity.builder()
                ...
                .investmentPct(domain.getInvestmentPct())
                ...
                // FIX: these three fields were missing — never persisted after settlement
                .lockedAt(domain.getLockedAt())
                .payoutAmountEtb(domain.getPayoutAmountEtb())
                .payoutAt(domain.getPayoutAt())
