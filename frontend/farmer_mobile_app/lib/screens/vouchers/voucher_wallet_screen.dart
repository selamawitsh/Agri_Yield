...
class _VoucherWalletScreenState extends State<VoucherWalletScreen>
  ...
  // Theme colours matching main.dart
  ...
  List<VoucherModel> _filtered(String tab) {
    switch (tab) {
      ...
      case 'Expired':  return _vouchers.where((v) => v.isExpired || v.isCancelled).toList();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: _tabs.map((t) {
            final count = t == 'All' ? _vouchers.length : _filtered(t).length;
          ...
          : Column(
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    controller: _tabController,
                    children: _tabs.map((t) => _buildVoucherList(_filtered(t))).toList(),
                  ),
                ),
              ],
            ),
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              _summaryTile('Total Value', '${s.totalValueEtb.toStringAsFixed(0)} ETB',
                  Colors.white, Colors.white70),
              _summaryTile('Redeemed', '${s.redeemedValueEtb.toStringAsFixed(0)} ETB',
                  const Color(0xFF86EFAC), Colors.white60),
              _summaryTile('Pending', '${s.pendingValueEtb.toStringAsFixed(0)} ETB',
              ...
              itemBuilder: (_, i) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Text(v.categoryEmoji, style: const TextStyle(fontSize: 10)),
                  ],
                );
              },
            ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(v.categoryEmoji, style: const TextStyle(fontSize: 22)),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            VoucherCategoryChip(category: v.productCategory),
